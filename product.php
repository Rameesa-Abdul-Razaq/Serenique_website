...
<head>
    ...
    <style>
        ...
        .overlay-btn { background: #fff; color: #2c2c2c; padding: .5rem 1.2rem; border-radius: 20px; font-size: .82rem; font-weight: 700; text-decoration: none; transition: background .15s; }
            ...
            <div class="products-grid" id="productsGrid">
                ...
                <div class="product-card <?php echo $isOOS ? 'out-of-stock' : ''; ?>">
                    ...
                    <div class="card-img-wrap">
                        <a href="<?php echo $u; ?>/product.php?id=<?php echo $p['id']; ?>">
                            <img src="<?php echo e($imgPath); ?>"
                                 alt="<?php echo e($p['name']); ?>"
                                 loading="lazy">
                        </a>
                        <div class="card-overlay">
                            <a href="<?php echo $u; ?>/product.php?id=<?php echo $p['id']; ?>" class="overlay-btn">Quick View</a>
                        </div>
                    </div>
